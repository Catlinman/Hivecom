...
if (isset($_POST["delete"])) {
	...
	// TODO: Redirect with a message and additonal options.
	header('Location: '."/");
}
            ...
            <div class="content shadowed">
				...
				<form method="post" >
					...
					<div class="centered">
						...
						<a class="button" style="width: 240px" href="/user/manage/page/edit?uid=<?php echo htmlspecialchars($_GET["uid"]); ?>">Return to editing</a>
					</div>
					<br>
				</form>
            </div>
